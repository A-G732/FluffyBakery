<footer class="bg-pink-300 text-white mt-10">
    <div class="max-w-screen-xl mx-auto px-4 py-8 md:py-10">
        <div class="flex flex-col md:flex-row items-center justify-between">
            <!-- Logo e Identidad -->
            <a href="{{ url('/indexgeneral') }}" class="flex items-center space-x-3 mb-4 md:mb-0">
                <img src="{{ asset('img/logo.jpeg') }}" alt="Logo" class="h-14 w-auto rounded-full shadow-md">
        ...
        <form class="max-w-md mx-auto">
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    <label for="floating_first_name" class="peer-focus:font-medium absolute text-sm text-white text-white duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-pink-400 peer-focus:text-pink-400 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Primer nombre</label>
                </div>
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    <label for="floating_last_name" class="peer-focus:font-medium absolute text-sm text-white text-white duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-pink-400 peer-focus:text-pink-400 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Apellido</label>
                </div>
            </div>
            <div class="relative z-0 w-full mb-5 group">
                ...
                <label for="floating_email" class="peer-focus:font-medium absolute text-sm text-white text-white duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-pink-400 peer-focus:text-pink-400 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Correo electrónico</label>
            </div>
        ...
        <p class="text-center text-sm text-white">
            © {{ date('Y') }} <a href="{{ url('/') }}" class="hover:underline text-white">FluffyBakery™</a>. Todos los derechos reservados.
        </p>
    </div>
</footer>